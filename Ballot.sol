...
contract Ballot {
    //This declares a new complex ttyp which will
    // be used for various variables later.
    // It will represent a single voter.
    struct Voter {
        uint256 weight; // weight is accumplulated by delegation
    ...
    // State variable startTime records voting start time
    ...
    // A dyanamically-sized array of `Proposal` structs.
    Proposal[] public proposals;

    // Modifier voteEnded checks if the voting period is over
    modifier voteEnded() {
        require(
    ...
    function giveRightToVote(address voter) external {
        ...
        // are reverted.
        // This used to consumer all gas in old EVM Versions, but
        // not anymore.
    ...
    function delegate(address to) external {
        ...
        // Forward the delegation as long
        // `to` also delegated
        ...
        // Since `sender` is a refrence, this
